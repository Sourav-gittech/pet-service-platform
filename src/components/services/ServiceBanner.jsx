    ...
    return (
        <Box className="bg-gradient-to-b from-[#EFFFFF] to-[#d6b4f9] h-[842px]">
            <Container maxWidth="xl" className='flex flex-col h-screen items-center justify-center'>
                ...
                <img src="/banner/Footer-paw-design-element.png" alt="" className='absolute right-120 top-38' />
                ...
                <h1 className='text-[#180A32] text-[60px] mb-[8px] font-bold z-10'>Services</h1>
                ...
                <ul className='text-[#180A32] flex justify-between w-[150px] p-3 border-2 bg-white border-white rounded-2xl cursor-pointer mt-5'>
