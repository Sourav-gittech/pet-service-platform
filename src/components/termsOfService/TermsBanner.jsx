    ...
    return (
        <Box className="bg-gradient-to-b from-[#EFFFFF] to-[#d6b4f9] h-[842px]">
            <Container maxWidth="xl" className='flex flex-col h-screen items-center justify-center'>
                ...
                <h1 className='text-[#180A32] text-[60px] mb-[8px] font-bold z-10'>Terms of Services</h1>
                ...
                <ul className='text-[#180A32] flex justify-between w-[220px] p-3 border-2 bg-white border-white rounded-2xl cursor-pointer mt-5'>
                    <li><Link to='/'>Home</Link></li>
                    <li>/</li>
                    <li><Link to='/terms' className='font-bold'>Terms of Services</Link></li>
                </ul>
            </Container>
        </Box>
    )
