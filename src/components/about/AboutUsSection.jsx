          ...
          <Grid container spacing={2} className='pt-12'>
            <Grid size={{ xs: 12, md: 6, lg: 5 }}>
              <Box className='relative'>
                ...
                <img src="/about-section/Curly-haired-girl-home.jpg" alt="#banner" className='h-[450px] absolute top-6 rounded-se-4xl rounded-ee-4xl rounded-es-4xl z-10 border-2 border-white' />
                <img src="/about-section/Smiling-doctor-holding-dog.jpg" alt="#banner" className='h-[500px] absolute top-30 right-2 rounded-se-4xl rounded-ss-4xl  rounded-es-4xl' />
            ...
            <Grid size={{ xs: 12, md: 6, lg: 7 }}>
              <Box className='relative'>
                ...
                <h2 className='absolute text-[#180A32] text-[52px] font-extrabold mt-22 z-10'>World’s Best Team For Pet Services</h2>
                <Box className='absolute text-[#544E5F] text-[20px] mt-62 mx-0'>
                  <Box className='mb-10'>
                  ...
                  <Box className='ml-5'>
                    <Box className='mb-0'><FaCheckCircle className='inline text-[#9631e9]' /> 25+ Years of Experience in Pet Care.</Box> <br />
                    <Box className='mb-0'><FaCheckCircle className='inline text-[#9631e9]' /> Compassionate & Certified Professionals.</Box> <br />
                    <Box className='mb-0'><FaCheckCircle className='inline text-[#9631e9]' /> Safe, Clean, and Friendly Environment.</Box> <br />
                    <Box className='mb-0'><FaCheckCircle className='inline text-[#9631e9]' /> Full Range of Services – Grooming, Training, Veterinary, Boarding & More.</Box>
                  </Box>
                </Box>
